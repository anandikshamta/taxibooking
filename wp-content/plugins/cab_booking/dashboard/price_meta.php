...
class PriceMeta
{
	...
	function CreatePrice()
	{
		if($_POST['id']):
			...
			$query = "select price.*, price_meta_data.standard_pricing, price_meta_data.outof_hours_pricing, ".
						" price_meta_data.radious_pricing, price_meta_data.hourly_table_price".
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="standing_fee" id="standing_fee" value="<?php echo $rs->standard_pricing; ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="minimum_price " id="minimum_price" value="<?php echo $rs->hourly_table_price; ?>">
							</div>
						</div>
					</div>
					<div class="row">
